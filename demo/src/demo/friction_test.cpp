...
public:
        ...
        : Demo(game)
    {
        ...
        RigidBody* b = world->CreateCapsule(6.5f, 0.05f, true, identity, RigidBody::static_body);
        b->SetPosition(-0.6f, 5.0f);
        b->SetRotation(-0.15f);
        b->SetFriction(groundFriction);

        b = world->CreateCapsule(6.5f, 0.05f, true, identity, RigidBody::static_body);
        ...
        b = world->CreateBox(0.1f, 1.1f, identity, RigidBody::static_body);
