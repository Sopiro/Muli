...
public:
        ...
        : Demo(game)
    {
        ...
        world->CreateCapsule(Vec2{ h, 6.0f }, Vec2{ h, 0.0f }, 0.05f, identity, RigidBody::static_body);
        world->CreateCapsule(Vec2{ h, 6.0f }, Vec2{ -1.0f, 6.0f }, 0.05f, identity, RigidBody::static_body);
