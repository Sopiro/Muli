...
public:
        ...
        : Demo(game)
    {
        ...
        RigidBody* pillar = world->CreateBox(pillarWidth, yStart, identity, RigidBody::Type::static_body);
        ...
        pillar = world->CreateBox(pillarWidth, yStart, identity, RigidBody::Type::static_body);
