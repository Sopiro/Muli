...
public:
        ...
        : Demo(game)
    {
        ...
        Joint* j = world->CreateRevoluteJoint(b0, bl, b0->GetPosition() - Vec2{ 0.2f, 0.0f }, 20.0f, 1.0f);
        ...
        for (int32 i = 1; i < 14; ++i)
        {
            ...
            j = world->CreateRevoluteJoint(b0, b1, (b0->GetPosition() + b1->GetPosition()) * 0.5f, 20.0f, 1.0f);

            b0 = b1;
        }

        j = world->CreateRevoluteJoint(br, b0, b0->GetPosition() + Vec2{ 0.2f, 0.0f }, 20.0f, 1.0f);
    }
