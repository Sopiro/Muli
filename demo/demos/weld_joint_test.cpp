...
public:
        ...
        : Demo(game)
    {
        ...
        Body* wall = world->CreateCapsule(Vec2{ wallX, 0.0f }, Vec2{ wallX, 5.0f }, wallRadius, identity, Body::static_body);
        ...
        world->CreateWeldJoint(wall, b0, b0->GetPosition(), freq, damp);
        ...
        for (int32 i = 1; i < count; ++i)
        {
            ...
            world->CreateWeldJoint(b0, b1, b0->GetPosition() + Vec2{ w / 2.0f, 0.0f }, freq, damp);
