...
public:
        ...
        : Demo(game)
    {
        ...
        case 2:
            ...
            break;
        case 3:
            target = CreateRandomConvexPolygon(world, 0.28f, 6, identity, Body::dynamic_body, 0.05f);
        ...
        world->CreateCapsule(Vec2{ h, 6.0f }, Vec2{ h, 0.0f }, 0.05f, identity, Body::static_body);
        world->CreateCapsule(Vec2{ h, 6.0f }, Vec2{ -1.0f, 6.0f }, 0.05f, identity, Body::static_body);
