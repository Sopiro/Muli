...
GrabJoint::GrabJoint(
    RigidBody* body, const Vec2& anchor, const Vec2& targetPosition, float frequency, float dampingRatio, float jointMass
)
    : Joint(grab_joint, body, body, frequency, dampingRatio, jointMass)
    , impulseSum{ 0.0f }
{
